...
public class Constants {
	...
	private String kafkaBrokerHost = "sandbox.hortonworks.com";
	private String kafkaBrokerPort = "6667";
	private String incomingTransactionsTopicName = "IncomingTransactions";
	private String processedTransactionTopicName = "ProcessedTransactions";
	...
	public Constants(){
        ...
        if(env.get("KAFKA_BROKER_HOST") != null){
        	this.kafkaBrokerHost = (String)env.get("KAFKA_BROKER_HOST");
        }
        if(env.get("KAFKA_BROKER_PORT") != null){
        	this.kafkaBrokerPort = (String)env.get("KAFKA_BROKER_PORT");
        }
        ...
        if(env.get("ATLAS_HOST") != null){
        	this.atlasHost = (String)env.get("ATLAS_HOST");
        }
        if(env.get("ATLAS_PORT") != null){
        	this.atlasPort = (String)env.get("ATLAS_PORT");
        }
	...
	public String getProcessedTransactionTopicName() {
		return processedTransactionTopicName;
	}

	public void setProcessedTransactionTopicName(String processedTransactionTopicName) {
		this.processedTransactionTopicName = processedTransactionTopicName;
	}
